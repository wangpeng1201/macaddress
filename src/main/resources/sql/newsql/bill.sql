...
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'mac地址申请单' ROW_FORMAT = Dynamic;
...
INSERT INTO `application` VALUES (4, '002268FEF140', '002268FFFFFE', 'PE/EPDIII/CESBG', 'PE/EPDIII/CESBG', 69311, '周德剛', '2020-10-20 00:00:00', '2020-10-20 00:00:00', '費用轉嫁 3312.48 NTD  HH2018030885', '費用轉嫁 3312.48 NTD  HH2018030885', 3312.48, 'root', '2020-10-20 17:25:28', '2020-10-26 11:25:55', 'wangwu', 1);
INSERT INTO `application` VALUES (5, '1', '1', '1', '1', 1, '1', '2020-10-21 00:00:00', '2020-10-21 00:00:00', '1', '1', 1.00, 'root', '2020-10-21 09:01:21', '2020-10-26 11:25:48', 'wangwu', 1);
...
INSERT INTO `application` VALUES (9, NULL, NULL, '3', '3', 3, '3', '2020-10-21 00:00:00', NULL, NULL, NULL, NULL, 'wangwu', '2020-10-21 10:41:31', '2020-10-26 11:21:06', 'wangwu', 1);
INSERT INTO `application` VALUES (10, NULL, NULL, '9', '9', 999, '9', '2020-10-21 00:00:00', NULL, NULL, NULL, NULL, 'wangwu', '2020-10-21 10:43:07', '2020-10-26 11:23:06', 'wangwu', 1);
INSERT INTO `application` VALUES (11, NULL, NULL, '33', '33', 333333, '33', '2020-10-20 00:00:00', NULL, NULL, NULL, NULL, 'wangwu', '2020-10-21 10:49:31', '2020-10-26 11:23:26', 'wangwu', 1);
...
INSERT INTO `application` VALUES (20, NULL, NULL, '555555555', '5555555', 555555, '5555555555', '2020-10-23 00:00:00', '2020-10-23 00:00:00', '5555', '5555', 555555.00, 'root', '2020-10-23 10:55:46', '2020-10-23 10:55:46', NULL, 1);
INSERT INTO `application` VALUES (21, NULL, NULL, '222222222222222222', '111111111111111', 222, '2222222222222', '2020-10-23 00:00:00', NULL, NULL, NULL, NULL, 'root', '2020-10-23 11:17:46', '2020-10-23 11:17:46', NULL, 1);
INSERT INTO `application` VALUES (22, NULL, NULL, '9999999', '9999999', 9999, '99999999', '2020-10-23 00:00:00', NULL, NULL, NULL, NULL, 'root', '2020-10-23 11:25:53', '2020-10-23 11:25:53', NULL, 1);
INSERT INTO `application` VALUES (23, NULL, NULL, '666666666', '6666666', 6666666, '66666', '2020-10-23 00:00:00', NULL, NULL, NULL, NULL, 'root', '2020-10-23 14:33:22', '2020-10-23 14:33:22', NULL, 1);
INSERT INTO `application` VALUES (24, NULL, NULL, '测试部门', '张三', 20000000, '张三', '2020-10-26 00:00:00', NULL, NULL, NULL, NULL, 'wangwu', '2020-10-26 14:03:30', '2020-10-26 14:31:27', 'wangwu', 1);
...
CREATE TABLE `delivery_record`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'mac地址交付记录，此表代表申请提交后从mac地址表中分配的记录，若存在跨段(申请数量大于mac地址表该段可用数量)，则同一个mac_id生成多个记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of delivery_record
-- ----------------------------
INSERT INTO `delivery_record` VALUES (1, 1, '00016C06A625', '00016C06A627', 9, 3, '2020-10-27 08:47:23', 'wangwu', '2020-10-27 08:59:47', 'wangwu', 1);
...
CREATE TABLE `macaddress`  (
  ...
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '是否显示(0:不显示，1:显示)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '库存总表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of macaddress
-- ----------------------------
INSERT INTO `macaddress` VALUES (1, '00016C', '00016C06A625', '00016C06A629', 5, NULL, '2020-10-13 09:34:27', 'root', '2020-10-26 09:40:52', NULL, 1);
INSERT INTO `macaddress` VALUES (2, 'BC9830', 'BC9830686430', 'BC98306864FF', 208, NULL, '2020-10-13 09:37:02', 'root', '2020-10-20 09:30:58', NULL, 1);
...
INSERT INTO `macaddress` VALUES (29, '90FBA6', '90FBA6760000', '90FBA685FFFF', 1048576, NULL, '2020-10-23 14:22:05', 'root', '2020-10-23 14:25:39', NULL, 1);
